package com.manyan.anime.detail
...
import com.manyan.anime.databinding.ActivityDetailBinding
                    ...
                    is Resource.Success -> {
                        ...
                        it.data?.let { anime ->
                            ...
                            binding.tvPopularityDetail.text =
                                getString(R.string.most_popularity_rank, anime.popularityRank.toString())
